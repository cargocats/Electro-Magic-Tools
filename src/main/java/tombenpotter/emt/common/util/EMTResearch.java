    ...
    public static void addResearch() {
        ...
        if (ConfigHandler.ironOmnitoolResearch == false) {
            if (ConfigHandler.diamondOmnitoolResearch == false) {
                new EMTResearchItem("Diamond Omnitool", "EMT", ResearchAspects.diamondOmnitoolResearch, -4, 0, 1, new ItemStack(ItemRegistry.diamondOmnitool)).setSecondary().setParents("Electric Magic Tools").setConcealed().registerResearchItem()
