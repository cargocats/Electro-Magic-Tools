...
public class DE_Fusion_Crafter extends GT_MetaTileEntity_EnhancedMultiBlockBase<DE_Fusion_Crafter> {
    ...
    private static final List<Pair<Block, Integer>> fusionCasingTiers =
            Arrays.asList(Pair.of(GregTech_API.sBlockCasings4, 6), Pair.of(GregTech_API.sBlockCasings4, 8));
    ...
    private static final IStructureDefinition<DE_Fusion_Crafter> STRUCTURE_DEFINITION =
            StructureDefinition.<DE_Fusion_Crafter>builder()
                    ...
                    .addElement(
                            ...
                            ofBlocksTiered(
                                    ...
                                    fusionCasingTiers,
                                    -1,
                                    (e, i) -> e.mFusionTierCasing = i,
                                    e -> e.mFusionTierCasing))
                    .addElement(
                            'R',
                            ofBlocksTiered(
                                    (Block b, int m) -> {
    ...
    protected GT_Multiblock_Tooltip_Builder createTooltip() {
        ...
        tt.addMachineType("Fusion Crafter")
                ...
                .addInfo("To see the structure, use a " + EnumChatFormatting.BLUE + "Tec" + EnumChatFormatting.DARK_BLUE
                        + "Tech" + EnumChatFormatting.GRAY + " structure hologram on the Controller!")
                .addSeparator()
    ...
    public boolean checkRecipe(ItemStack aStack) {
        ...
        if (tInputs.length > 0) {
            ...
            GT_Recipe tRecipe = EMT_RecipeAdder.sFusionCraftingRecipes.findRecipe(
                    getBaseMetaTileEntity(), false, V[tTier], tFluids, tInputs);
            if ((tRecipe != null)
                    && (this.mTierCasing >= tRecipe.mSpecialValue)
