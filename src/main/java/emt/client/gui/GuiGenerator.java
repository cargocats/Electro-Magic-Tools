...
public class GuiGenerator extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        String formatPanelName = I18n.format(this.tileentity.getInventoryName());
        ...
        String storageString = I18n.format("emt.Storage");
        String fuel = I18n.format("emt.Fuel");
        if (this.tileentity.maxstorage < 1000)
            this.fontRendererObj.drawString(
                    storageString + this.tileentity.mpshownstroage * 1000 + "/" + this.tileentity.maxstorage + "EU",
                    36,
                    22,
                    0);
        else if (10000 <= this.tileentity.maxstorage && this.tileentity.maxstorage < 10000000)
            this.fontRendererObj.drawString(
                    storageString + (this.tileentity.mpshownstroage) + "/" + (this.tileentity.maxstorage / 1000)
                            + "kEU",
                    36,
                    22,
                    0);
            ...
            this.fontRendererObj.drawString(
                    storageString + (this.tileentity.mpshownstroage / 1000) + "/"
                            + (this.tileentity.maxstorage / 1000000) + "MEU",
                    36,
                    22,
                    0);
        else if (1000000000 <= this.tileentity.maxstorage)
            this.fontRendererObj.drawString(
                    storageString + (this.tileentity.mpshownstroage / 1000000) + "/"
        ...
        if (this.tileentity.isActive)
            this.fontRendererObj.drawString(
                    I18n.format("emt.Generating") + Double.toString(this.tileentity.generating / 20 / 20) + " EU/t",
                    36,
                    35,
                    0);
        else this.fontRendererObj.drawString(I18n.format("emt.Generating") + "0 EU/t", 36, 35, 0);
        this.fontRendererObj.drawString(fuel + ": " + Integer.toString(this.tileentity.fuel), 36, 48, 0);
        this.fontRendererObj.drawString(
                fuel + "/t: " + Integer.toString((this.tileentity.fuel * 20 * 20) - this.tileentity.tick), 36, 63, 0);
    }
