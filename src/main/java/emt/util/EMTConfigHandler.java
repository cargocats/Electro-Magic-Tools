...
public class EMTConfigHandler {
    ...
    public static void syncConfig() {
        ...
        oneRingSpawn = config.get(
                        RANDOM, "Disable One Ring in dungeon chests", true, "There is a recipe to get this item.")
        ...
        chanceOneRing = config.get(
                        ...
                        "If you have a lot of mods adding dungeon loot, you should definetely increase this")
                .getInt();
        removeAmberAndCinnabarMacerating = config.get(
                        RANDOM,
        ...
        etherealMaceratorWhiteList.addAll(Arrays.asList(config.get(
                        RANDOM,
        ...
        EMT_GT_Loader.aIDoffset = config.get(
                        VALUES,
        ...
        wandChargerConsumption = config.get(
                        VALUES,
        ...
        nanoBootsSpeed = config.get(
                        VALUES, "Nano Boots of the Traveller Speed", 0.25, "Watch out, that goes up REALLY quickly.")
                .getDouble(nanoBootsSpeed);
        quantumBootsSpeed = config.get(
                        VALUES, "Quantum Boots of the Traveller Speed", 0.5, "Watch out, that goes up REALLY quickly.")
                .getDouble(quantumBootsSpeed);
        nanoBootsJump = config.get(
                        VALUES, "Nano Boots of the Traveller jump", 0.6, "Watch out, that goes up REALLY quickly.")
                .getDouble(nanoBootsJump);
        quantumBootsJump = config.get(
                        VALUES, "Quantum Boots of the Traveller jump", 0.9, "Watch out, that goes up REALLY quickly.")
                .getDouble(nanoBootsJump);
        etherealProcessorBaseSpeed = config.get(
                        VALUES, "Etheral Processor speed", 400, "Default is 400, the double of a regular furnace")
                .getInt();
        etherealProcessorBonus = config.get(
                ...
                .getInt();
        chargeFocusProduction = config.get(VALUES, "Wand Focus: Charge production", 64, "Default is 64")
                .getInt();
        armorBaubleProduction = config.get(VALUES, "Armor Charging Ring production", 32, "Default is 32")
                .getInt();
        inventoryBaubleProdution = config.get(VALUES, "Inventory Charging Ring production", 32, "Default is 32")
                .getInt();
        wandChargeFocusCost = config.get(VALUES, "Wand Focus: Wand Charging Cost", 40000, "Default is 40000")
                .getInt();
        ...
        nanoBootsMinDrop = config.get(
                ...
                .getDouble(nanoBootsMinDrop);
        nanoBootsMaxDrop = config.get(
                        VALUES,
        ...
        quantumBootsMinDrop = config.get(
                        ...
                        10.0,
                        "The distance allowed to fall without any damage")
                .getDouble(quantumBootsMinDrop);
        quantumBootsMaxDrop = config.get(
                        VALUES,
        ...
        thaumiumChainsawResearch =
                config.get(RESEARCH, "Thaumium Chainsaw", false).getBoolean(thaumiumChainsawResearch);
        thaumiumDrillResearch = config.get(RESEARCH, "Thaumium Omnitool", false).getBoolean(thaumiumOmnitoolResearch);
        rockbreakerDrillResearch =
                config.get(RESEARCH, "Drill of the Rockbreaker", false).getBoolean(rockbreakerDrillResearch);
        streamChainsawResearch =
                config.get(RESEARCH, "Chainsaw of the Stream", false).getBoolean(streamChainsawResearch);
        electricGooglesResearch =
                config.get(RESEARCH, "Electric Googles of Revealing", false).getBoolean(electricGooglesResearch);
        nanoGooglesResearch =
                config.get(RESEARCH, "Nanosuit Googles of Revealing", false).getBoolean(nanoGooglesResearch);
        quantumGooglesResearch =
                config.get(RESEARCH, "Quantum Googles of Revealing", false).getBoolean(quantumGooglesResearch);
        ironOmnitoolResearch = config.get(RESEARCH, "Omnitool", false).getBoolean(ironOmnitoolResearch);
        diamondOmnitoolResearch =
                config.get(RESEARCH, "Diamond Omnitool", false).getBoolean(diamondOmnitoolResearch);
        ...
        energyBallFocusResearch =
                config.get(RESEARCH, "EnergyBall Focus", false).getBoolean(christmasFocusResearch);
        ...
        potentiaGeneratorResearch =
                config.get(RESEARCH, "Potentia Generator", false).getBoolean(potentiaGeneratorResearch);
        ...
        lucrumGeneratorResearch =
                config.get(RESEARCH, "Lucrum Generator", false).getBoolean(lucrumGeneratorResearch);
        wandChargingSationResearch =
                config.get(RESEARCH, "Industrial Wand Charging Station", false).getBoolean(wandChargingSationResearch);
        tinyUraniumResearch =
                config.get(RESEARCH, "Tiny Piles of Uranium", false).getBoolean(tinyUraniumResearch);
        thorHammerResearch = config.get(RESEARCH, "Mjolnir", false).getBoolean(thorHammerResearch);
        superchargedThorHammerResearch =
                config.get(RESEARCH, "Supercharged Mjolnir", false).getBoolean(superchargedThorHammerResearch);
        compressedSolarsResearch =
                config.get(RESEARCH, "Compressed Solars", false).getBoolean(compressedSolarsResearch);
        solarHelmetResearch =
                config.get(RESEARCH, "Solar Helmet of Revealing", false).getBoolean(solarHelmetResearch);
        electricBootsResearch =
                config.get(RESEARCH, "Electric Boots of the Traveller", false).getBoolean(electricBootsResearch);
        nanoBootsResearch =
                config.get(RESEARCH, "Nano Boots of the Traveller", false).getBoolean(nanoBootsResearch);
        quantumBootsResearch =
                config.get(RESEARCH, "Quantum Boots of the Traveller", false).getBoolean(quantumBootsResearch);
        electricScribingToolsResearch =
                config.get(RESEARCH, "Electric Scribing Tools", false).getBoolean(electricScribingToolsResearch);
        etherealProcessorResearch =
                config.get(RESEARCH, "Ethereal Processor", false).getBoolean(etherealProcessorResearch);
        ...
        electricHoeGrowthResearch =
                config.get(RESEARCH, "Electric Hoe of Growth", false).getBoolean(electricHoeGrowthResearch);
        chargeFocusResearch =
                config.get(RESEARCH, "Wand Focus: Charging", false).getBoolean(chargeFocusResearch);
        wandChargeFocusResearch =
                config.get(RESEARCH, "Wand Focus: Wand Charging", false).getBoolean(wandChargeFocusResearch);
        inventoryChargingRing =
                config.get(RESEARCH, "Inventory Charging Ring", false).getBoolean(inventoryChargingRing);
        armorChargingRing = config.get(RESEARCH, "Armor Charging Ring", false).getBoolean(armorChargingRing);
        thaumiumWingResearch =
                config.get(RESEARCH, "Thaumium Reinforced Wings", false).getBoolean(thaumiumWingResearch);
        ...
        infusedQuantumChestplate =
                config.get(RESEARCH, "Infused Quantum Chestplate", false).getBoolean(infusedQuantumChestplate);
