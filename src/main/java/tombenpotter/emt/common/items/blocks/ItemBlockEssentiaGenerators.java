...
public class ItemBlockEssentiaGenerators extends ItemBlock {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean par4) {
        switch(stack.getItemDamage()){
        	case 0 : list.add(ConfigHandler.potentiaGenerator + " EU/t");
        			 break;
        	case 1 : list.add(ConfigHandler.ignisGenerator + " EU/t");
        			 break;
        	case 2 : list.add(ConfigHandler.auramGenerator + " EU/t");
        			 break;
        	case 3 : list.add(ConfigHandler.arborGenerator + " EU/t");
        			 break;
        	case 4 : list.add(ConfigHandler.aerGenerator + " EU/t");
        			 break;
        }
    }
