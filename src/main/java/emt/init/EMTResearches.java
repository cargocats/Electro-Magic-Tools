...
public class EMTResearches {
    ...
    public static void addResearch() {
        ...
        new EMTResearchItem("ResearchCompleter", -4, -2, 0, new ItemStack(GregTech_API.sBlockMachines, 1, 13001)).setParents("Electric Magic Tools").registerResearchItem().setPages(new ResearchPage(""), new ResearchPage(EMTRecipes.magicalMachineCasing), new ResearchPage(EMTRecipes.researchCompleter));
        /*************************************/
