...
import tombenpotter.emt.common.item.ItemElectricScribingTools;
import tombenpotter.emt.common.item.ItemIC2Baubles;
import tombenpotter.emt.common.item.ItemMaterials;
import tombenpotter.emt.common.item.ItemOneRing;
import tombenpotter.emt.common.item.armor.boots.ItemElectricBootsTraveller;
import tombenpotter.emt.common.item.armor.boots.ItemNanoBootsTraveller;
import tombenpotter.emt.common.item.armor.boots.ItemQuantumBootsTraveller;
import tombenpotter.emt.common.item.armor.chestplate.ItemInfusedQuantumChestplate;
import tombenpotter.emt.common.item.armor.goggles.ItemElectricGoggles;
import tombenpotter.emt.common.item.armor.goggles.ItemNanoGoggles;
import tombenpotter.emt.common.item.armor.goggles.ItemQuantumGoggles;
import tombenpotter.emt.common.item.armor.goggles.ItemSolarHelmetRevealing;
import tombenpotter.emt.common.item.armor.wings.ItemFeatherWing;
import tombenpotter.emt.common.item.armor.wings.ItemNanoWing;
import tombenpotter.emt.common.item.armor.wings.ItemQuantumWing;
import tombenpotter.emt.common.item.armor.wings.ItemThaumiumReinforcedWing;
import tombenpotter.emt.common.item.focus.ItemChargeFocus;
import tombenpotter.emt.common.item.focus.ItemChristmasFocus;
import tombenpotter.emt.common.item.focus.ItemExplosionFocus;
import tombenpotter.emt.common.item.focus.ItemShieldFocus;
import tombenpotter.emt.common.item.focus.ItemWandChargingFocus;
import tombenpotter.emt.common.item.tool.ItemElectricHoeGrowth;
import tombenpotter.emt.common.item.tool.ItemElectricThorHammer;
import tombenpotter.emt.common.item.tool.ItemThorHammer;
import tombenpotter.emt.common.item.tool.ItemThorHammerBroken;
import tombenpotter.emt.common.item.tool.chainsaw.ItemDiamondChainsaw;
import tombenpotter.emt.common.item.tool.chainsaw.ItemStreamChainsaw;
import tombenpotter.emt.common.item.tool.chainsaw.ItemThaumiumChainsaw;
import tombenpotter.emt.common.item.tool.drill.ItemRockbreakerDrill;
import tombenpotter.emt.common.item.tool.drill.ItemThaumiumDrill;
import tombenpotter.emt.common.item.tool.omnitool.ItemOmnitoolDiamond;
import tombenpotter.emt.common.item.tool.omnitool.ItemOmnitoolIron;
import tombenpotter.emt.common.item.tool.omnitool.ItemOmnitoolThaumium;
